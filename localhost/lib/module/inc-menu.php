<div class='menu-con-release'>
	<span>Website Release Preview 2022.02.21</span>
</div>
...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		...
		<div class="menu-con-inner">
			...
			<a href='/sumka'>
			<div class="menu-btn-select">
				<span>Сумка вожатого</span>		
			</div>
			</a>
			<a href='/vojati24'>
			<div class="menu-btn-select">
				<span>Вожатый на 24 часа</span>
			</div>
			</a>
			<a href='/roadmap'>
			<div class="menu-btn-select">
				<span>Шпаргалка вожатого</span>
			</div>
			</a>
			<a href='/about'>
			<div class="menu-btn-select">
			...
			<a href='https://www.tiktok.com/@shtab_barsu' target="_blank">
			<div class="menu-btn-select">
				<span>TikTok</span>
			</div>
			</a>
			<a href='https://vk.com/shtab_barsu' target="_blank">
			<div class="menu-btn-select">
				<span>ВКонтакте</span>
			</div>
			</a>
