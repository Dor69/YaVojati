...
$(document).ready(function() {
	...
	$('.scale-content-txt-12').css({
		'position': 'absolute',
		'top': '50%',
		'margin-top': -$('.scale-content-txt-12').height() / 2 // Divide div height by half
	});
});
...
$(document).ready(function() {
	...
	$(".page-video-11").click(function() {
		$('.video-img-viewport').show().delay(500).fadeOut();
	});
	$(".page-video-12").click(function() {
		$('.video-img-viewport').show().delay(500).fadeOut();
	});
	...
	$(".toggle-video-4").fadeOut(); // Open video #4
	$(".page-video-4").click(function() {
		$(".toggle-video-4").fadeIn('fast');
	});
	$(".toggle-video-4").fadeOut(); // Close video #4
	$(".close-video").click(function() {
		$(".toggle-video-4").fadeOut('fast');
	});
	$(".toggle-video-5").fadeOut();
	$(".page-video-5").click(function() { // Open video #5
		$(".toggle-video-5").fadeIn('fast');
	});
	$(".toggle-video-5").fadeOut(); // Close video #5
	$(".close-video").click(function() {
		$(".toggle-video-5").fadeOut('fast');
	});
	$(".toggle-video-6").fadeOut(); // Open video #6
	$(".page-video-6").click(function() {
		$(".toggle-video-6").fadeIn('fast');
	});
	$(".toggle-video-6").fadeOut(); // Close video #6
	$(".close-video").click(function() {
		$(".toggle-video-6").fadeOut('fast');
	});
	$(".page-video-4").click(function() {
		var iframe = $("#video-4"); // Load video #4's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-5").click(function() {
		var iframe = $("#video-5"); // Load video #5's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-6").click(function() {
		var iframe = $("#video-6"); // Load video #6's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".toggle-video-7").fadeOut(); // Open video #7
	$(".page-video-7").click(function() {
		$(".toggle-video-7").fadeIn('fast');
	});
	$(".toggle-video-7").fadeOut(); // Close video #7
	$(".close-video").click(function() {
		$(".toggle-video-7").fadeOut('fast');
	});
	$(".toggle-video-8").fadeOut();
	$(".page-video-8").click(function() { // Open video #8
		$(".toggle-video-8").fadeIn('fast');
	});
	$(".toggle-video-8").fadeOut(); // Close video #8
	$(".close-video").click(function() {
		$(".toggle-video-8").fadeOut('fast');
	});
	$(".toggle-video-9").fadeOut(); // Open video #9
	$(".page-video-9").click(function() {
		$(".toggle-video-9").fadeIn('fast');
	});
	$(".toggle-video-9").fadeOut(); // Close video #9
	$(".close-video").click(function() {
		$(".toggle-video-9").fadeOut('fast');
	});
	$(".page-video-7").click(function() {
		var iframe = $("#video-7"); // Load video #7's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-8").click(function() {
		var iframe = $("#video-8"); // Load video #8's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-9").click(function() {
		var iframe = $("#video-9"); // Load video #9's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".toggle-video-10").fadeOut(); // Open video #10
	$(".page-video-10").click(function() {
		$(".toggle-video-10").fadeIn('fast');
	});
	$(".toggle-video-10").fadeOut(); // Close video #10
	$(".close-video").click(function() {
		$(".toggle-video-10").fadeOut('fast');
	});
	$(".toggle-video-11").fadeOut();
	$(".page-video-11").click(function() { // Open video #11
		$(".toggle-video-11").fadeIn('fast');
	});
	$(".toggle-video-11").fadeOut(); // Close video #11
	$(".close-video").click(function() {
		$(".toggle-video-11").fadeOut('fast');
	});
	$(".toggle-video-12").fadeOut(); // Open video #12
	$(".page-video-12").click(function() {
		$(".toggle-video-12").fadeIn('fast');
	});
	$(".toggle-video-12").fadeOut(); // Close video #12
	$(".close-video").click(function() {
		$(".toggle-video-12").fadeOut('fast');
	});
	$(".page-video-10").click(function() {
		var iframe = $("#video-10"); // Load video #10's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-11").click(function() {
		var iframe = $("#video-11"); // Load video #11's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(".page-video-12").click(function() {
		var iframe = $("#video-12"); // Load video #12's iframe
		iframe.attr("src", iframe.data("src"));
	});
	$(function() {
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #4
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #5
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #6
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #7
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #8
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #9
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #10
		});
	...
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #11
		});

		function videoControl(action) {
			var $playerWindow = $('#video-11')[0].contentWindow;
			$playerWindow.postMessage('{"event":"command","func":"' + action + '","args":""}', '*');
		}
	});
	$(function() {
		$(".stop-video").on("click", function() {
			videoControl("stopVideo"); // Stop and un-load video #12
		});

		function videoControl(action) {
			var $playerWindow = $('#video-12')[0].contentWindow;
			$playerWindow.postMessage('{"event":"command","func":"' + action + '","args":""}', '*');
		}
	});
});
...
$(document).ready(function() {
	$('s[rel="anchor-select"]').click(function() {
		$('html, body').animate({
			scrollTop: $($.attr(this, 'href')).offset().top
		}, 500); //Scroll within 500ms
		return false;
